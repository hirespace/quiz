$(document).ready(function(){
	...
	function descriptions() {
		return [
		"<h5 class='upper'>Waste of Space</h5>Wuhoh! Your mind is full of empty space. You're like <a href='http://hirespace.com/Venues/1024/Shoreditch-Town-Hall'>Shoreditch Town Hall</a>, but without the pretty face.",
		...
		"<h5 class='upper'>Space Bar</h5>Oh dear. Your knowledge is as tiny as <a href='http://hirespace.com/Spaces/10615/ArtsLav/The-Lavs/Film-and-Photo'>Arts Lav</a>, and twice as untidy. Urgent spring clean required.",
		"<h5 class='upper'>Outta Space</h5>Like the <a href='http://hirespace.com/Venues/2400/The-Safehouses-Maverick-Project'>Safehouses in Peckham</a>, you might be cool, but you're just a bit too edgy. Dip back into the mainstream for a while.",
		...
		"<h5 class='upper'>Watch this Space</h5>Like <a href='http://hirespace.com/Venues/420/The-Anthologist'>The Anthologist</a>, you're taking the scene by storm. Maintain this effortless brilliance and you'll soon be an institution.",
		"<h5 class='upper'>Super Space Freak</h5>Like <a href='http://hirespace.com/Venues/210/SearcysThe-Gherkin'>Searcy's at the Gherkin</a>, you think you're above everyone else - and you are. Tell your friends."
		]
	}
	// The answers!
	function answers() {
